...
csvfilename='Your File Name.csv'
outdirname='C:/Your directory name/all_inbox/in/out/test'
...
#        print('\n From Index :-'+ str(startFrom))
#
#        print("Start OF To Final-->"+ str(startTo))
#        print("End OF To-->"+ str(endTo))
#       
#        print("Header Line Number At the end :" + str(HeaderEndLineNumber))
#        print('From Index :-'+ str(startFrom))
#        print('CC Index:-'+ str(startCC))
#        print('Cc Index:-'+ str(startCc))
#        print('BCC Index:-'+ str(startBCC))
#        print('Date Index:-'+ str(startDate))
...
#################  END Of HTML TAG                    ##############
                ...
                #PT=PT.lstrip()
                #PT = PT.replace('\n\n','')
## Formatting to Remove multiple next lines to a single next line
#                PT = PT.replace('\n','&&&')
#                PT = PT.replace('&&&&&&','')
#                PT = PT.replace('&&&','\n')
 
 
                #PT=PT.replace((re.search("----boundary-LibPST-iamunique",PT,re.IGNORECASE)),'')
                #print(PT)   
